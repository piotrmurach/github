...
describe Github::Result do
  ...
  it "should read response content_type " do
    res.header.content_type.should match 'application/json'
  end

  it "should read response content_length " do
    res.header.content_length.should match '344'
  end

  it "should read response ratelimit limit" do
    res.header.ratelimit_limit.should == '5000'
  end

  it "should read response ratelimit remaining" do
    res.header.ratelimit_remaining.should == '4999'
  end

  it "should read response status" do
    res.header.status.should be 200
  end

  it 'should read response etag' do
    res.header.etag.should eql "\"d9a88f20567726e29d35c6fae87cef2f\""
  end

  it 'should read response date' do
    res.header.date.should eql "Sun, 05 Feb 2012 15:02:34 GMT"
  end

  it 'should read response server' do
    res.header.server.should eql "nginx/1.0.4"
  end

  it "should assess successful" do
    res.header.success?.should be_true
  end
