...
#   let(:link) {
#     Github::PageLinks.new({"Link" => "<https://api.github.com/users/wycats/repos?page=4&per_page=20>; rel=\"next\", <https://api.github.com/users/wycats/repos?page=6&per_page=20>; rel=\"last\", <https://api.github.com/users/wycats/repos?page=1&per_page=20>; rel=\"first\", <https://api.github.com/users/wycats/repos?page=2&per_page=20>; rel=\"prev\""})
#   }
...
# 
#   let(:instance)     { Github::PageIterator.new(link, current_api) }

  # let(:sha_instance) { Github::PageIterator.new(sha_env, current_api) }
