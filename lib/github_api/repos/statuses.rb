...
module Github
  class Repos::Statuses < API
    ...
    #
    # = Inputs
    # * <tt>:state</tt> - Required string - State of the status - can be one of pending, success, error, or failure.
    # * <tt>:target_url</tt> - Optional string - Target url to associate with this status. This URL will be linked from the GitHub UI to allow users to easily see the ‘source’ of the Status.
