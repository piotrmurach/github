...
At this state you can also supply various configuration parameters, such as :user, :repo, :org etc..,
...
For specification on all available methods go to http://developer.github.com/v3/
...
* Add request caching - local filestore?.
